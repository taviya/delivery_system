						...
						<div class="page-header">
							...
							<div class="page-header-breadcrumb">
								<ul class="breadcrumb-title">
									...
									<li class="breadcrumb-item"><a href="javascript:;">Admin Profile</a>
									</li>
								</ul>
							</div>
						</div>
												...
												<div class="col-md-12">
													<div class="media-left">
														<a href="#" class="profile-image">
															<img class="user-img img-circle" src="{{asset('assets/images/user.png')}}" alt="user-img">
														</a>
													</div>
								...
								<div class="col-lg-12">
									...
									<div class="tab-header">
										<ul class="nav nav-tabs md-tabs tab-timeline" role="tablist" id="mytab">
											<li class="nav-item">
												<a class="nav-link active" data-toggle="tab" href="#personal" role="tab">Admin Info</a>
												<div class="slide"></div>
											</li>
											<li class="nav-item">
											...
											<li class="nav-item">
												<a class="nav-link" data-toggle="tab" href="#contacts" role="tab">Admin Image</a>
												<div class="slide"></div>
											</li>
											<li class="nav-item">
																			...
																			<table class="table">
																				<tbody>
																					<tr>
																						...
																						<td><a href="mailto:{{ $adminDetails->email }}">{{ $adminDetails->email }}</a></td>
																					</tr>
																				</tbody>
																			</table>
																		</div>
																...
																<form action="{{ route('admin.profile.update') }}" method="POST">
																	...
																	<div class="general-info">
																						...
																						<tr>
																							<td>
																								<div class="input-group">
																									...
																									<input type="text" class="form-control" name="name" placeholder="Name" value="{{ $adminDetails->name }}" required="">
																								</div>
																							</td>
																						</tr>
																					</tbody>
																						...
																						<tr>
																							<td>
																								<div class="input-group">
																									...
																									<input type="email" class="form-control" name="email" placeholder="Email" value="{{ $adminDetails->email }}" required="">
																								</div>
																							</td>
																						</tr>
																					</tbody>
																		...
																		<div class="text-center">
																			<input type="submit" class="btn btn-primary waves-effect waves-light m-r-20" value="Save">
										...
										<div class="tab-pane" id="binfo" role="tabpanel">
											...
											<div class="card">
												...
												<div class="card-block">
													...
													<form action="{{ route('admin.changepassword') }}" method="POST" id="changepasswordform" novalidate="">
														{{csrf_field()}}
													...
													<form action="{{route('admin.logoIcon.update')}}" method="post" enctype="multipart/form-data">
														...
														<div class="form-group row has-error">
															<label class="col-sm-2 col-form-label">
																<img class="" src="{{asset('assets/images/user.png')}}" height="100px" width="120px" alt="User-Profile-Image">
															</label>
